...
public class BarChartExample extends Application {
   ...
   public void start(Stage stage) {    
      ...
      observableArrayList(Arrays.asList("mot", "hai", "ba")));
      ...
      series1.getData().add(new XYChart.Data<>("mot", 1.0));
      series1.getData().add(new XYChart.Data<>("hai", 3.0));
      series1.getData().add(new XYChart.Data<>("ba", 5.0));
//      series1.getData().add(new XYChart.Data<>("Safety", 5.0));
//        
//      XYChart.Series<String, Number> series2 = new XYChart.Series<>();
//      series2.setName("Audi");
////      series2.getData().add(new XYChart.Data<>("Speed", 5.0));
//      series2.getData().add(new XYChart.Data<>("hai", 6.0));
